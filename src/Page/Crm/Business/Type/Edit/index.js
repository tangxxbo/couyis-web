...
class Edit extends Component {
	...
	componentDidMount= () =>{
		...
		if(type.typeFlows !=null){			
			this.setState({
				typeFlows:type.typeFlows
			})
		}
	}
	...
	// 		console.log(nextProps.type.typeFlows)
	// 		if(nextProps.type.typeFlows !=null){
	// 			this.setState({
	// 				typeFlows:nextProps.type.typeFlows
	// 			})
	// 		}
	// 	}
	// }
	...
	render() {       
		...
		return (
				...
				<Form {...formItemLayout}  ref={this.formRef}  onFinish={this.onFinish} initialValues={{...type}}>
					<Tabs >
